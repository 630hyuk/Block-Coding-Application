        ...
        binding?.btnNextChapterTen?.setOnClickListener {
            ...
            if (order!! < 5) {
                findNavController().navigate(
                    R.id.action_stageTwoChapterTenResultFragment_to_stageTwoChapterTenQuizOXFragment,
                    bundle
                )
                ...
                findNavController().navigate(
                    R.id.action_stageTwoChapterTenResultFragment_to_lastResultTwoFragment,
                    bundle
                )
            } else {
                findNavController().navigate(
                    R.id.action_stageTwoChapterTenResultFragment_to_stageTwoChapterTenQuizFourFragment,
                    bundle
                )
            }
        }
