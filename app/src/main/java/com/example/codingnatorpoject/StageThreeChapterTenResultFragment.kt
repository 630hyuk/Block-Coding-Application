        ...
        binding?.btnNextChapterTen?.setOnClickListener {
            ...
            if (order == 2) {  //챕터10의 ox가 두 문제 뿐이니, 이렇게 만들어줬습니다.
                findNavController().navigate(
                    R.id.action_stageThreeChapterTenResultFragment_to_stageThreeChapterTenQuizOXFragment,
                    bundle
                )
                ...
                findNavController().navigate(
                    R.id.action_stageThreeChapterTenResultFragment_to_lastResultThreeFragment,
                    bundle
                )
            } else {
                findNavController().navigate(
                    R.id.action_stageThreeChapterTenResultFragment_to_stageThreeChapterTenQuizFourFragment,
                    bundle
                )
            }
        }
