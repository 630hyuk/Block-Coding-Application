...
class IntroduceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(chapterNumber == 1){
            ...
            binding?.imgIntro?.setImage(ImageSource.resource(R.drawable.introduce1))
        }

        if(chapterNumber == 2){
            showEducation(chapterNumber!!)
            binding?.imgIntro?.setImage(ImageSource.resource(R.drawable.introduce2))
        }

        if(chapterNumber == 3){
            showEducation(chapterNumber!!)
            binding?.imgIntro?.setImage(ImageSource.resource(R.drawable.introduce3))
        }

        if(chapterNumber == 4){
            showEducation(chapterNumber!!)
            binding?.imgIntro?.setImage(ImageSource.resource(R.drawable.introduce4))
        }

        if(chapterNumber == 5){
            showEducation(chapterNumber!!)
            binding?.imgIntro?.setImage(ImageSource.resource(R.drawable.introduce5))
        }

        if(chapterNumber == 6){
            showEducation(chapterNumber!!)
            binding?.imgIntro?.setImage(ImageSource.resource(R.drawable.introduce6))
        }

        if(chapterNumber == 7){
            showEducation(chapterNumber!!)
            binding?.imgIntro?.setImage(ImageSource.resource(R.drawable.introduce7))
        }

        if(chapterNumber == 8){
            showEducation(chapterNumber!!)
            binding?.imgIntro?.setImage(ImageSource.resource(R.drawable.introduce8))
        }

        if(chapterNumber == 9){
            showEducation(chapterNumber!!)
            binding?.imgIntro?.setImage(ImageSource.resource(R.drawable.introduce9))
        }
