...
// password(plain) should be 6~32 characters
...
public class PasswordManager {
    ...
    public static String encrypt(String pw) throws InvalidPasswordException{
        if (!isValidPassword(pw)) throw new InvalidPasswordException();
        return header + pw.hashCode();
    }

    public static boolean isEncrypted(String pw) {
